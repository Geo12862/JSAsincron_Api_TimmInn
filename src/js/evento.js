window.onload = function() {
  ...
  //     document.getElementById("subseccion"+n).style.overflowX="scroll"
  //     }
  // function ocultar(n) {
  ...
  let menu_nuevo = document.querySelector('#nuevo');
  document.querySelector(".edit1").onclick = function overlayOn() {
      
    document.getElementById("overlay").style.display = "block";
    console.log(document.getElementById("modif").dataset.id = 1);

  }
  document.querySelector(".edit2").onclick = function overlayOn() {
      
    document.getElementById("overlay").style.display = "block";

  }
  document.querySelector(".edit3").onclick = function overlayOn() {
      
    document.getElementById("overlay").style.display = "block";

  }
    menu_nuevo.addEventListener('click', function overlayOn() {
    ...
    document.getElementById("btn-cerrar-popup").addEventListener('click', function overlayOff(){
...
function crearEvento(){
    for (index=0; index < 3; index ++){
        ...
        h3.innerHTML = events[index].titulo;
...
function Cookies(){
  ...
  if (galleta == "") {
      ...
      setTimeout(function () {
          ...
          cookieParent.setAttribute("id", "cookieParent");
          cookieOverlaytext.setAttribute("id", "botonCookie");
          ...
          document.getElementById("botonCookie").onclick = crearcookie();
...
function crearcookie() {
        let cookieParent = document.getElementById("cookieParent");
